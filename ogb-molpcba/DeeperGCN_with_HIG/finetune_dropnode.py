...
def main():
    ...
    if True:
       ...
       # checkpoint_path = './saved_models/EXP-B_res+-C_gen-L_14-F_256-DP_0.2-GA_softmax-T_1.0-LT_True-P_1.0-LP_False-Y_0.0-LY_False-MN_False-LS_False-RS_0/model_ckpt/'
       # checkpoint_path = '../256_onlyGen_gamma_500/'
       best_pth = 'BS_512-NF_full_valid_best_AUC_E_237_R0.pth'
       # best_pth = 'BS_512-NF_full_valid_best_AUC_E_280_R0.pth'
...
if __name__ == "__main__":
    ...
    aucm_criterion = AUCMLoss().to(args.device)
